...
namespace WindowsApplication1
{
    ...
    class HashCalculator
    {
        ...
        public delegate void ResultCallback(string result, int index);
        public event ResultCallback resultCallback;
        ...
        public List<string> result = new List<string>(5);
        ...
        public void ThreadCalcCRC32File()
        {
            switch (Hash)
            {
                case "CRC32":
            ...
            for (int i = 0; i < files.Count; ++i)
            {
                ...
                {
                    Console.WriteLine("ThreadCalcCRC32File Break;");
                    break;
                }
            }
        }
